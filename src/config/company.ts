...
export const company = {
  ...
  positioning:
    "A service-disabled veteran-owned federal IT services firm pursuing SDVOSB, HUBZone, and 8(a) designations.",
  /** Compact positioning line used in the hero eyebrow / meta. */
  positioningShort: "SDVOSB · HUBZone-eligible · 8(a)-track federal IT services",
  ...
  /** HUBZone-qualifying office location. PENDING. */
  hubzoneOffice: null as string | null,
...
export const certifications: ReadonlyArray<Certification> = [
  ...
  },
  {
    name: "HUBZone",
    status: "in-process",
    statusLabel: "Eligibility established — application in preparation",
    detail:
      "Historically Underutilized Business Zone program. Principal-place-of-business eligibility established; certification application in preparation.",
  },
  {
...
export const differentiators: ReadonlyArray<Differentiator> = [
  {
    ...
    body: "Pursuing SDVOSB, HUBZone, and 8(a) designations — positioning the firm to support agency small-business and socioeconomic goals across multiple set-aside channels.",
  },
  {
